// Project: web_remote_monitoring
// Copyright (c) 2023 M2M craft Co., Ltd.
...
class _DropdownMenuState<T> extends State<DropdownMenu<T>> {
  ...
  List<DropdownMenuEntry<T>> filter(
    ...
    return entries
        .where(
          (entry) => entry.label.toLowerCase().contains(filterText),
        )
        .toList();
  }
              ...
              Positioned(
                ...
                child: widget.showHide == null
                    ...
                    : InkWell(
                        ...
                        onTap: widget.onTapTrailingIcon,
                        child: Icon(
                          widget.showHide!
                              ? CupertinoIcons.eye
...
class _RenderDropdownMenuBody extends RenderBox
  ...
  void performLayout() {
    ...
    while (child != null) {
      ...
      child.layout(innerConstraints, parentUsesSize: true);
      final _DropdownMenuBodyParentData childParentData = child.parentData!
          as _DropdownMenuBodyParentData
        ..offset = Offset.zero;
